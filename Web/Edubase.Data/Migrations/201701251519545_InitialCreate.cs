    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        HeadPreferredJobTitle = c.String(),
                        AdditionalAddresses = c.String(),
                        CreatedUtc = c.DateTime(nullable: false, precision: 7, storeType: "datetime2"),
                        LastUpdatedUtc = c.DateTime(nullable: false, precision: 7, storeType: "datetime2"),
                        IsDeleted = c.Boolean(nullable: false),
                        RowVersion = c.Binary(nullable: false, fixedLength: true, timestamp: true, storeType: "rowversion"),
                ...
                .ForeignKey("dbo.LookupDeliveryModel", t => t.CCDeliveryModelId)
                ...
                .ForeignKey("dbo.LookupCCGroupLead", t => t.CCGroupLeadId)
                ...
                c => new
                    {
                        ...
                        Head_TitleDistilled = c.String(),
                        Head_FirstNameDistilled = c.String(),
                        Head_MiddleNameDistilled = c.String(),
                        Head_LastNameDistilled = c.String(),
                        Address = c.String(),
                        ManagerEmailAddress = c.String(),
                        GroupId = c.String(maxLength: 400),
                        EstablishmentCount = c.Int(nullable: false),
                        LocalAuthorityId = c.Int(),
                        CreatedUtc = c.DateTime(nullable: false, precision: 7, storeType: "datetime2"),
                        LastUpdatedUtc = c.DateTime(nullable: false, precision: 7, storeType: "datetime2"),
                        IsDeleted = c.Boolean(nullable: false),
                ...
                c => new
                    {
                        ...
                        Person_TitleDistilled = c.String(),
                        Person_FirstNameDistilled = c.String(),
                        Person_MiddleNameDistilled = c.String(),
                        Person_LastNameDistilled = c.String(),
                        ...
                        PreviousPerson_TitleDistilled = c.String(),
                        PreviousPerson_FirstNameDistilled = c.String(),
                        PreviousPerson_MiddleNameDistilled = c.String(),
                        PreviousPerson_LastNameDistilled = c.String(),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.EstablishmentGroup", "GroupUID", "dbo.GroupCollection");
            DropForeignKey("dbo.GroupCollection", "StatusId", "dbo.LookupGroupStatus");
            DropForeignKey("dbo.GroupCollection", "LocalAuthorityId", "dbo.LocalAuthority");
            ...
            DropForeignKey("dbo.Establishment", "CCGroupLeadId", "dbo.LookupCCGroupLead");
            ...
            DropForeignKey("dbo.Establishment", "CCDeliveryModelId", "dbo.LookupDeliveryModel");
            ...
            DropIndex("dbo.GroupCollection", new[] { "LocalAuthorityId" });
            ...
            DropIndex("dbo.EstablishmentGroup", new[] { "GroupUID" });
