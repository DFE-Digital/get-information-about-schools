    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Establishment", t => t.EstablishmentUrn, cascadeDelete: true)
                .ForeignKey("dbo.LookupGovernorAppointingBody", t => t.GovernorAppointingBodyId)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Governor", "GovernorAppointingBodyId", "dbo.LookupGovernorAppointingBody");
            ...
            DropForeignKey("dbo.EstablishmentLink", "LinkedEstablishment_Urn", "dbo.Establishment");
            DropForeignKey("dbo.EstablishmentLink", "Establishment_Urn", "dbo.Establishment");
            ...
            DropIndex("dbo.EstablishmentLink", new[] { "LinkedEstablishment_Urn" });
            DropIndex("dbo.EstablishmentLink", new[] { "Establishment_Urn" });
