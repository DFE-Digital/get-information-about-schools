namespace Edubase.Services.Cache
{
    ...
    public class CacheAccessor : ICacheAccessor, IDisposable
    {
        ...
        private EndPoint ServerEndPoint { get; set; }
        ...
        /// <summary>
        /// Creates a cache accessor using the supplied config.
        /// In general, use this constructor ONLY for testing
        /// </summary>
        /// <param name="config"></param>
        public CacheAccessor(CacheConfig config)
        {
            _config = config;
        ...
        /// <summary>
        /// Factory for the Cache Accessor.
        /// Only use in the context of unit testing or bootstrapping IoC
        /// </summary>
        /// <returns></returns>
        public static ICacheAccessor Create()
        {
            return new CacheAccessor(new CacheConfig()) as ICacheAccessor;
        }
        ...
        {
            MessageLoggingService.Instance.Push(ex);
        ...
        public async Task ClearAsync()
        {
            ...
            await _connection.GetServer(ServerEndPoint).FlushAllDatabasesAsync();
        }
        ...
        public void Clear()
        {
            _memoryCache.Dispose();
            _memoryCache = new MemoryCache(_config.Name);
            _connection.GetServer(ServerEndPoint).FlushAllDatabases();
        }
