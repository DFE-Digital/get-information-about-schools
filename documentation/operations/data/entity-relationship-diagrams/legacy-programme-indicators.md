...
These values appear to represent historic DfE initiatives rather than active provider-register concepts. They are still present in current data structures and extracts, but that does not mean they should automatically be treated as current business vocabulary.
