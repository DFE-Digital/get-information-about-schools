...
namespace Edubase.IntegrationTest.Services.IntegrationEndPoints
{
    [TestFixture]
    public class AzureSearchEndPointTest
    {
        ...
        private string GetAZSConnStr() => ConfigurationManager.ConnectionStrings[CONNSTR]?.ConnectionString;

        private string GetRemoteSqlDEVConnStr() => ConfigurationManager.ConnectionStrings[SQLCONNSTRREMOTE_DEV]?.ConnectionString;
    }
}
