...
//        private readonly Mock<HttpRequest> mockHttpRequestBase = new Mock<HttpRequest>(MockBehavior.Strict);
//        private readonly Mock<HttpContext> mockHttpContextBase = new Mock<HttpContext>(MockBehavior.Strict);
