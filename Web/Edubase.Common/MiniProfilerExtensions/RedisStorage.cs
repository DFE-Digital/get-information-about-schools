...
namespace Edubase.Common.MiniProfilerExtensions
{
    /// <summary>
    ...
    public class RedisStorage : IStorage
    {
        ...
        /// </summary>
        public RedisStorage(TimeSpan cacheDuration, ICacheAccessor cacheAccessor)
        : this(cacheDuration, "default", cacheAccessor)
        {
        }
        ...
        public RedisStorage(TimeSpan cacheDuration, string cacheProfileName, ICacheAccessor cacheAccessor)
        {
        ...
        public MiniProfiler Load(Guid id)
        {
            ...
            var result = _cacheAccessor.Get<MiniProfiler>(GetCacheKey(id));
            return result;
        }
        ...
        private void InsertIntoCache(string key, object value)
        {
            ...
            _cacheAccessor.Set(key, value, null);
        }
        ...
        private List<Guid> GetPerUserUnviewedIds(string user)
        {
            ...
            var result = _cacheAccessor.Get<List<Guid>>(key); //Cache[key] as List<Guid>;
            ...
            if (result == null)
            {
                lock (AddPerUserUnviewedIdsLock)
                {
                    ...
                    result = _cacheAccessor.Get<List<Guid>>(key); //Cache[key] as List<Guid>;
                    if (result == null)
                    {
