...
namespace Edubase.Web.UI.Models
{
    public class DownloadsViewModel
    {
        ...
        public IEnumerable<Section> GetFileDownloadGroups()
        {
            ...
            var allEstabData = Downloads?.Where(x => new[] { "all.edubase.data", "all.edubase.data.links", "all.edubase.additional.addresses" }.Contains(x.Tag)) ?? Array.Empty<FileDownload>();
