...
namespace Edubase.Services.Texuna.Approvals
{
    public class ApprovalService : IApprovalService
    {
        ...
        public async Task<PendingApprovalsResult> GetAsync(int skip, int take, string sortBy, IPrincipal principal) => (await _httpClient.GetAsync<PendingApprovalsResult>($"approvals/pending?skip={skip}&take={take}&sortby={sortBy}", principal)).GetResponse();
    }
}
