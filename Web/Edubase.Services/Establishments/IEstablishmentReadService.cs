...
namespace Edubase.Services.Establishments
{
    ...
    public interface IEstablishmentReadService
    {
        ...
        Task<List<ChangeDescriptorDto>> GetModelChangesAsync(EstablishmentModel model, EstablishmentApprovalsPolicy approvalsPolicy, IPrincipal principal);

        Task<List<ChangeDescriptorDto>> GetModelChangesAsync(EstablishmentModel original, EstablishmentModel model, EstablishmentApprovalsPolicy approvalsPolicy);
