...
namespace Edubase.ServicesUnitTests.Governors
{
    public class GovernorRoleNameFactoryTests
    {
        ...
        [InlineData(eLookupGovernorRole.GovernanceProfessionalToALocalAuthorityMaintainedSchool, "Governance professional - local authority maintained school")]
        [InlineData(eLookupGovernorRole.GovernanceProfessionalToAFederation, "Governance professional - federation")]
        [InlineData(eLookupGovernorRole.GovernanceProfessionalToAnIndividualAcademyOrFreeSchool, "Local governance professional - individual academy or free school")]
        ...
        [InlineData(eLookupGovernorRole.ChairOfLocalGoverningBody, "Chairs of local governing body")]
        [InlineData(eLookupGovernorRole.Group_SharedChairOfLocalGoverningBody, "Shared chairs of local governing body - group")]
        [InlineData(eLookupGovernorRole.AccountingOfficer, "Accounting officers")]
        [InlineData(eLookupGovernorRole.ChairOfGovernors, "Chairs of governors")]
        [InlineData(eLookupGovernorRole.ChairOfTrustees, "Chairs of trustees")]
        [InlineData(eLookupGovernorRole.ChiefFinancialOfficer, "Chief financial officers")]
        [InlineData(eLookupGovernorRole.Establishment_SharedChairOfLocalGoverningBody, "Shared chairs of local governing body - establishment")]
        ...
        [InlineData(eLookupGovernorRole.GovernanceProfessionalToALocalAuthorityMaintainedSchool, "Governance professionals - local authority maintained school")]
        [InlineData(eLookupGovernorRole.GovernanceProfessionalToAFederation, "Governance professionals - federation")]
        [InlineData(eLookupGovernorRole.GovernanceProfessionalToAnIndividualAcademyOrFreeSchool, "Local governance professionals - individual academy or free school")]
        ...
        [InlineData(eLookupGovernorRole.ChairOfLocalGoverningBody, "Chairs of local governing body")]
        [InlineData(eLookupGovernorRole.Group_SharedChairOfLocalGoverningBody, "Shared chairs of local governing body")]
        [InlineData(eLookupGovernorRole.AccountingOfficer, "Accounting officers")]
        [InlineData(eLookupGovernorRole.ChairOfGovernors, "Chairs of governors")]
        [InlineData(eLookupGovernorRole.ChairOfTrustees, "Chairs of trustees")]
        [InlineData(eLookupGovernorRole.ChiefFinancialOfficer, "Chief financial officers")]
        [InlineData(eLookupGovernorRole.Establishment_SharedChairOfLocalGoverningBody, "Shared chairs of local governing body")]
