...
{
    public class NewsArticleAuditViewModel
    {
        public List<NewsArticle> Articles { get; }

        public NewsArticleAuditViewModel(IEnumerable<NewsArticle> items, string sortBy)
        {
            var sortOrder = "desc";
            ...
            if (sortOrder == "desc")
            {
                switch (sortBy)
                {
                    ...
                    case nameof(NewsArticle.Version):
