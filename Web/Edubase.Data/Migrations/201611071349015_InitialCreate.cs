namespace Edubase.Data.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        CompanyGroupUID = c.Int(nullable: false),
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Trust", t => t.CompanyGroupUID, cascadeDelete: true)
                .ForeignKey("dbo.Establishment", t => t.EstablishmentUrn, cascadeDelete: true)
                .Index(t => t.CompanyGroupUID)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Establishment2Company", "CompanyGroupUID", "dbo.Trust");
