...
<head>
        ...
        (function () {
            ...
            setTimeout(function() {
                var a = document,
                    g,
                    b = {
                        families: (g =["nta"]),urls: ["/public/govuk_template/assets/stylesheets/fonts-ie8.css?0.12.0"]
                    },
                    c = "/public/govuk_template/assets/javascripts/vendor/goog/webfont-debug.js?0.12.0",
                    d = "script",
                    e = a.createElement(d),
    ...
    <![endif]-->
    <!--[if gte IE 9]><!-->
    <link href="/public/govuk_template/assets/stylesheets/fonts.css?0.12.0" media="all" rel="stylesheet" type="text/css" />
    <!--<![endif]-->
    <!--[if lt IE 9]>
    <script src="/public/govuk_template/assets/javascripts/ie.js?0.12.0" type="text/javascript"></script>
    <![endif]-->

    <link rel="shortcut icon" href="/public/govuk_template/assets/images/favicon.ico?0.12.0" type="image/x-icon" />

    <!-- Size for iPad and iPad mini (high resolution) -->
    <link rel="apple-touch-icon-precomposed" sizes="152x152" href="/public/govuk_template/assets/images/apple-touch-icon-152x152.png?0.12.0">
    <!-- Size for iPhone and iPod touch (high resolution) -->
    <link rel="apple-touch-icon-precomposed" sizes="120x120" href="/public/govuk_template/assets/images/apple-touch-icon-120x120.png?0.12.0">
    <!-- Size for iPad 2 and iPad mini (standard resolution) -->
    <link rel="apple-touch-icon-precomposed" sizes="76x76" href="/public/govuk_template/assets/images/apple-touch-icon-76x76.png?0.12.0">
            ...
            <div class="govuk-width-container">
                <div class="govuk-service-navigation__container">
                    <span class="govuk-service-navigation__service-name">
                        @Html.ActionLink("Get Information about Schools", "Index", "Home", new { area = "" }, new { id = "proposition-name", @class = "govuk-service-navigation__link" })
                    </span>
                    ...
                    <nav aria-label="Menu" class="govuk-service-navigation__wrapper">
                        ...
                        <ul class="govuk-service-navigation__list" id="navigation">
                            @Html.NavigationItem((string)ViewBag.siteSection, "home", "Home", "Index", "Home", "home-link")
                            @Html.NavigationItem((string)ViewBag.siteSection, "search", "Search", "Index", "Search", "search-link")
                            @Html.NavigationItem((string)ViewBag.siteSection, "downloads", "Downloads", "Index", "Downloads", "downloads-link")

                            @if (Request.IsAuthenticated)
                            {
                                @Html.NavigationItem((string)ViewBag.siteSection, "tools", "Tools", "Index", "Tools", "tools-link")
                            }

                            @Html.NavigationItem((string)ViewBag.siteSection, "about", "About", "About", "Home", "about-link")
                            @Html.NavigationItem((string)ViewBag.siteSection, "help", "Help", "Help", "Home", "help-link")
                            @Html.NavigationItem((string)ViewBag.siteSection, "news", "News", "Index", "News", "news-link")

                            @if (Request.IsAuthenticated)
                            {
                                <li class="govuk-service-navigation__item">
                                    @Html.ActionLink("Sign out", "LogOff", "Account", new { area = "", returnUrl = currentUrl.PathAndQuery }, new { id = "logout-link", Class = "govuk-service-navigation__link logout-link ", rel = "nofollow" })
                                </li>
                            }
                            else
                            {
                                <li class="govuk-service-navigation__item">
                                    @Html.ActionLink("Sign in", "LogIn", "Account", new { area = "", returnUrl = currentUrl.PathAndQuery }, new { id = "login-link", Class = "govuk-service-navigation__link login-link ", rel = "nofollow" })
                                </li>
                            }
                        </ul>
                    </nav>
...
<div class="grid-row">
    <div class="column-full">
        ...
        <h1 class="heading-xlarge">Access denied</h1>
    </div>
            ...
            <div class="govuk-footer__meta">
                <div class="govuk-footer__meta-item govuk-footer__meta-item--grow">
                    ...
                    <ul class="govuk-footer__inline-list">
                        ...
                        <li class="govuk-footer__inline-list-item">@Html.ActionLink("Terms of use", "Index", "TermsofUse", new { area = "" }, new { @class = "govuk-footer__link" })</li>
                        <li class="govuk-footer__inline-list-item">@Html.ActionLink("Privacy", "Privacy", "Home", new { area = "" }, new { @class = "govuk-footer__link" })</li>
...
<!--end footer-->
        ...
        <!--[if IE 9]>
        <script src="/public/termi/element.details.ie8.js"></script>
        <!--<![endif]-->
        <!--[if gt IE 9]>
