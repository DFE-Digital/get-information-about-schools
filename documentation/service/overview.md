...
4. For more detail on how front-end authentication works between GIAS and DfE Sign-in, see [front-end-authentication-flow.md](./front-end-component/front-end-authentication-flow.md).
