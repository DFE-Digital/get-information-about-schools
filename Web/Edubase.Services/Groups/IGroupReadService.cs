...
namespace Edubase.Services.Groups
{
    public interface IGroupReadService
    {
        ...
        Task<ApiPagedResult<SearchGroupDocument>> SearchByIdsAsync(string groupId, int? groupUId, string companiesHouseNumber, int? ukprn, IPrincipal principal);
        ...
        Task<List<ChangeDescriptorDto>> GetModelChangesAsync(GroupModel model, IPrincipal principal);
    }
}
